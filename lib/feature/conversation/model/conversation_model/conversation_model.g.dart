...
void _conversationModelSerialize(
  ...
  writer.writeString(offsets[2], object.llmId);
...
ConversationModel _conversationModelDeserialize(
  ...
  final object = ConversationModel(
    ...
    id: id,
    llmId: reader.readStringOrNull(offsets[2]),
...
extension ConversationModelQueryFilter
  ...
  QueryBuilder<ConversationModel, ConversationModel, QAfterFilterCondition>
      llmIdContains(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
        property: r'llmId',
        value: value,
  ...
  QueryBuilder<ConversationModel, ConversationModel, QAfterFilterCondition>
      llmIdMatches(String pattern, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
        property: r'llmId',
        wildcard: pattern,
...
extension ConversationModelQuerySortBy
  ...
  QueryBuilder<ConversationModel, ConversationModel, QAfterSortBy>
      sortByLlmId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'llmId', Sort.asc);
    });
  }
  ...
  QueryBuilder<ConversationModel, ConversationModel, QAfterSortBy>
      sortByLlmIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'llmId', Sort.desc);
    });
  }
...
extension ConversationModelQueryWhereDistinct
  ...
  QueryBuilder<ConversationModel, ConversationModel, QDistinct> distinctByLlmId(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'llmId', caseSensitive: caseSensitive);
    });
  }
...
extension ConversationModelQueryProperty
  ...
  QueryBuilder<ConversationModel, String?, QQueryOperations> llmIdProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'llmId');
    });
  }
